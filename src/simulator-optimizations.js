...
const {Battle, Dex, Pokemon} = require('@pkmn/sim');
const {installEmptyEventOptimization, isNativeFindEventHandlers} = require('./empty-events');
const {installResidualOptimization} = require('./residual-optimization');
const {hasNoEventHandlers} = require('./event-plan');
...
function installSimulatorOptimizations(battle, options = {}) {
...
module.exports = {installSimulatorOptimizations};
