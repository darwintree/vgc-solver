...
const STOCK_DEX: typeof sim.Dex = sim.Dex;
...
function buildStockProfile({dex = STOCK_DEX, cacheKeys = {}, runtimeFormats = []}: {dex?: typeof STOCK_DEX; cacheKeys?: Record<string, string[]>; runtimeFormats?: {id: string}[]} = {}) {
