...
function enumerateNative(snapshot, p1Action, p2Action) {
...
function assertSameDistribution(native, optimized, tolerance = 1e-12) {
...
module.exports = {assertSameDistribution, distribution, enumerateNative};
